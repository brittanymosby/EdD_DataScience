...
Now we can plot the result, using the `geom_smooth` layer to give us lines for every level of `bypared`. 
...
els<-els%>%mutate(bypared=fct_reorder(.f=as.factor(bypared),-bynels2m))
