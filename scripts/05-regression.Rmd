...
It's just a linear, additive model. $Y$ increases or decreases as a function of $x$, with multiple $x$'s included. The $\epsilon$ term is the extent to which an individual value is above or below the line created. 
...
Our dependent variable will be math scores, stored in this dataset as `bynels2m`. Let's take a look at this variable first.
